...
import AcademicDownloads from "../AboutPageContainers/AcademicDownloads/AcademicDownloads";

class Syllabusplan extends Component {
    ...
    render() {
        return (
            <div className="HomePage">
                ...
                <AcademicDownloads></AcademicDownloads>
